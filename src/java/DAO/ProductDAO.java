...
public class ProductDAO extends DBUtils {
    ...
    public List<Product> getProduct(int index) {
        List<Product> list = new ArrayList<Product>();
        String query = "select * from ProductLaptop\n"
                + "ORDER BY pId\n"
    ...
    public int getNumberEndPage() {
        Connection con = null;
        String query = "select count(*) from ProductLaptop";
        try {
    ...
    public List<Product> getNewProduc() {
        List<Product> list = new ArrayList<Product>();
        String query = "select top 3 * from ProductLaptop\n"
                + "order by pID desc";
        try {
            DBConnection = makeConnection();
            SQLQuery = DBConnection.prepareStatement(query);
    ...
    public List<Product> getNewProduc4() {
        List<Product> list = new ArrayList<Product>();
        String query = "select top 4 * from ProductLaptop\n"
                + "order by pID desc";
        try {
            DBConnection = makeConnection();
            SQLQuery = DBConnection.prepareStatement(query);
    ...
    public List<Product> getABrand(String bName, int index) {
        ...
        String query = "select * from ProductLaptop\n"
                ...
                + "OFFSET ? ROWS FETCH NEXT 6 ROWS ONLY";
        try {
            DBConnection = new DBUtils().makeConnection();
            SQLQuery = DBConnection.prepareStatement(query);
    ...
    public Product getAProduct(int pID) {
        String query = "select * from ProductLaptop where pID = ?";
        try {
            DBConnection = makeConnection();
            SQLQuery = DBConnection.prepareStatement(query);
    ...
    public Product checkProduct(int pID, int accountID) {
        String query = "select c.* from Account a, Carts c, ProductLaptop p\n"
    ...
    public void updateProduct(int pID, int quanlity, float price, String name, int bID) {
        String query = "update ProductLaptop set quality = ?, price = ?, bID = ?, pName = ? where pID = ?";
        try {
            DBConnection = makeConnection();
            SQLQuery = DBConnection.prepareStatement(query);
    ...
    public void deleteProduct(int pid) {
        String query = "delete from ProductLaptop where pID=?";
        try {
            DBConnection = makeConnection();
            SQLQuery = DBConnection.prepareStatement(query);
            SQLQuery.setInt(1, pid);
    ...
    public void Product(String pName, String imge, int number, double price, int bID) {
        String query = "insert into ProductLaptop values (?, ?, ?, ?, ?)";
        try {
            DBConnection = makeConnection();
            SQLQuery = DBConnection.prepareStatement(query);
